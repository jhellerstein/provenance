...
\begin{tabular}{@{}p{0.23\linewidth} p{0.54\linewidth} p{0.12\linewidth}@{}}
  ...
  $\Bigl(\!\bigwedge_{i\in\{1,2,3,4,6,7\}}\varphi_{\snap(T_i)=\emptyset}\Bigr)
    ...
    \wedge
    \Bigl(\!\bigwedge_{j=1}^7 \varphi_{T_j \in \snap(T_Q)}\Bigr) \linebreak
    \wedge
...
belong to a single commutative stage.
...
reflecting a sequence of non-commuting snapshot commitments.
