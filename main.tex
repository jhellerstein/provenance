...
over interpretive predicates for a given specification.
An edge $\varphi \rightarrow \psi$ indicates that the commitment $\psi$ cannot be
made until $\varphi$ has been resolved.
Such dependencies determine when a specification becomes resolved and hence when
ordinary (depth--0) derivational provenance is well-defined. 
