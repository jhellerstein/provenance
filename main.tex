...
(ii) show, via Datalog with negation, how different semantics regimes induce
...
uncertainty represented \emph{within} the observation domain $O$ itself (e.g.,
...
\]
such that for all histories $H$ and observation sets $S \subseteq O$:
...
Resolution therefore corresponds to determinism of $\Spec : \Hist \to O$.
